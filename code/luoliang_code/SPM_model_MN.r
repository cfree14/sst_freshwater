...
# Read STAN model
SPM_stan = stan_model(file=file.path(codedir, "Stan_code/SPM.stan"))


############# LB ###############

# reading input
input_LB = read.csv("data/raw/LB_MN.csv")
...
saveRDS(output,"Output/N_MN_LB.rda")
write.csv(output_quantities,"Output/N_MN_LB_quantities.csv",row.names = F)



############# SB ###############
# reading input
input_SB = read.csv("Data/SPM_data/SB_MN.csv")
...
saveRDS(output,"Output/N_MN_SB.rda")
write.csv(output_quantities,"Output/N_MN_SB_quantities.csv",row.names = F)

############# BC ###############
# reading input
input_BC = read.csv("Data/SPM_data/BC_MN.csv")
...
saveRDS(output,"Output/N_MN_BC.rda")
write.csv(output_quantities,"Output/N_MN_BC_quantities.csv",row.names = F)



############# WE ###############
# reading input
input_WE = read.csv("Data/SPM_data/WE_MN.csv")
...
saveRDS(output,"Output/N_MN_WE.rda")
write.csv(output_quantities,"Output/N_MN_WE_quantities.csv",row.names = F)

############# YP ###############
# reading input
input_YP = read.csv("Data/SPM_data/YP_MN.csv")
...
saveRDS(output,"Output/N_MN_YP.rda")
write.csv(output_quantities,"Output/N_MN_YP_quantities.csv",row.names = F)

############# CC ###############
# reading input
input_CC = read.csv("Data/SPM_data/CC_MN.csv")
...
# select the lakes that have adequate survey times
# delete lakes MNth only one cpue
input_CC = input_CC[input_CC$survey_time_cpue>1,]
...
for (i in 1:Nstocks){
  ...
  cpue_i = data_i[data_i$year>=min_year_i&data_i$year<=max_year_i,]$cpe
  env_i = scale(data_i[data_i$year>=min_year_i&data_i$year<=max_year_i,]$gdd_wtr_5c, scale = T)[,]
  env_i[is.na(env_i)] = mean(env_i,na.rm = T)
  stocking_i = data_i[data_i$year>=min_year_i&data_i$year<=max_year_i,]$stocking_weight
  tri_i = data_i[data_i$year>=min_year_i&data_i$year<=max_year_i,]$tri_harvest
...
saveRDS(output,"Output/N_MN_CC.rda")
write.csv(output_quantities,"Output/N_MN_CC_quantities.csv",row.names = F)

############# NP ###############
# reading input
input_NP = read.csv("Data/SPM_data/NP_MN.csv")
...
saveRDS(output,"Output/N_MN_NP.rda")
write.csv(output_quantities,"Output/N_MN_NP_quantities.csv",row.names = F)

############# BG ###############
# reading input
input_BG = read.csv("Data/SPM_data/BG_MN.csv")
...
saveRDS(output,"Output/N_MN_BG.rda")
write.csv(output_quantities,"Output/N_MN_BG_quantities.csv",row.names = F)
